...
engine = create_engine('sqlite:///chocolate_sources.sqlite', echo=False) # You might also have a config file, for example, that holds the string that is the db name. For now we'll just put it here.
